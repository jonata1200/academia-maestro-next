...
describe('CookieBanner', () => {
  ...
  it('salva recusa no localStorage ao recusar', async () => {
    const user = userEvent.setup();
    render(<CookieBanner />);
  ...
  it('não reaparece em nova visita se o consentimento foi recusado antes', () => {
    // Recusa também é uma resposta definitiva: banner não volta
