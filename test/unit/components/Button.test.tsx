...
describe('Button', () => {
  ...
  it('renderiza diferentes tamanhos', () => {
    ...
    expect(screen.getByRole('button')).toHaveClass('h-[3.25rem]');

    rerender(<Button size="md">Medium</Button>);
    expect(screen.getByRole('button')).toHaveClass('h-[3.75rem]');

    rerender(<Button size="lg">Large</Button>);
    expect(screen.getByRole('button')).toHaveClass('h-[4.25rem]');
  });
