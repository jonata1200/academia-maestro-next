    ...
    <div className="maps-grid">
      ...
      <div className="map-card">
        ...
        <div className="map-container">
          <iframe
            title="Mapa da localização da Academia Maestro em Ceilândia" // <-- Title de acessibilidade adicionado!
      ...
      <div className="map-card">
        ...
        <div className="map-container">
          <iframe
            title="Mapa da localização da Academia Maestro em Sobradinho" // <-- Title de acessibilidade adicionado!
