  ...
  return (
    <div className="pt-[180px] pb-20">
      <div className="max-w-[800px] mx-auto px-5 text-left leading-relaxed text-text-light">
        <h1 className="text-center mb-10 text-[2.5rem] text-dark-blue font-bold">Política de Privacidade</h1>

        <h2 className="text-[1.8rem] mt-10 mb-5 border-b-2 border-gray-200 pb-2.5 text-dark-blue font-bold">Artigo 1 - Introdução e Definições</h2>
        <p className="mb-5">
        ...
        <h2 className="text-[1.8rem] mt-10 mb-5 border-b-2 border-gray-200 pb-2.5 text-dark-blue font-bold">Artigo 2 - Dados Pessoais Coletados e Finalidades</h2>
        ...
        <h2 className="text-[1.8rem] mt-10 mb-5 border-b-2 border-gray-200 pb-2.5 text-dark-blue font-bold">Artigo 3 - Base Legal para o Tratamento</h2>
        ...
        <h2 className="text-[1.8rem] mt-10 mb-5 border-b-2 border-gray-200 pb-2.5 text-dark-blue font-bold">Artigo 4 - Armazenamento, Segurança e Retenção dos Dados</h2>
        <p className="mb-5">
        ...
        <h2 className="text-[1.8rem] mt-10 mb-5 border-b-2 border-gray-200 pb-2.5 text-dark-blue font-bold">Artigo 5 - Compartilhamento e Transferência Internacional de Dados</h2>
        <p className="mb-5">
        ...
        <h2 className="text-[1.8rem] mt-10 mb-5 border-b-2 border-gray-200 pb-2.5 text-dark-blue font-bold">Artigo 6 - Direitos do Titular</h2>
        ...
        <h2 className="text-[1.8rem] mt-10 mb-5 border-b-2 border-gray-200 pb-2.5 text-dark-blue font-bold">Artigo 7 - Política de Cookies</h2>
        <p className="mb-5">
