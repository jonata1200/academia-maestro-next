  ...
  return (
    <div className="pt-[180px] pb-20">
      <div className="max-w-[800px] mx-auto px-5 text-left leading-relaxed text-text-light">
        <h1 className="text-center mb-10 text-[2.5rem] text-dark-blue font-bold">Termos e Condições de Uso</h1>

        <h2 className="text-[1.8rem] mt-10 mb-5 border-b-2 border-gray-200 pb-2.5 text-dark-blue font-bold">Cláusula 1ª - Aceitação e Objeto</h2>
        <p className="mb-5">
        ...
        <h2 className="text-[1.8rem] mt-10 mb-5 border-b-2 border-gray-200 pb-2.5 text-dark-blue font-bold">Cláusula 2ª - Propriedade Intelectual</h2>
        <p className="mb-5">
        ...
        <h2 className="text-[1.8rem] mt-10 mb-5 border-b-2 border-gray-200 pb-2.5 text-dark-blue font-bold">Cláusula 3ª - Obrigações do Usuário</h2>
        ...
        <h2 className="text-[1.8rem] mt-10 mb-5 border-b-2 border-gray-200 pb-2.5 text-dark-blue font-bold">Cláusula 4ª - Isenção de Garantias e Limitação de Responsabilidade</h2>
        <p className="mb-5">
        ...
        <h2 className="text-[1.8rem] mt-10 mb-5 border-b-2 border-gray-200 pb-2.5 text-dark-blue font-bold">Cláusula 5ª - Indenização</h2>
        <p className="mb-5">
        ...
        <h2 className="text-[1.8rem] mt-10 mb-5 border-b-2 border-gray-200 pb-2.5 text-dark-blue font-bold">Cláusula 6ª - Modificações e Rescisão</h2>
        <p className="mb-5">
        ...
        <h2 className="text-[1.8rem] mt-10 mb-5 border-b-2 border-gray-200 pb-2.5 text-dark-blue font-bold">Cláusula 7ª - Lei Aplicável e Foro</h2>
        <p className="mb-5">
